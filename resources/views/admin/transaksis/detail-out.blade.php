    ...
    <div class="bg-white w-full p-4 lg:p-8 rounded-lg shadow-lg relative">
        ...
        <div class="container mx-auto px-4 py-6">
            ...
            <div class="bg-white rounded shadow overflow-x-auto">
                ...
                <a href="{{ route('stock-out-detail.download', $stockOut->id) }}" target="_blank"
                    class="inline-block bg-red-500 hover:bg-red-600 text-white text-sm px-4 py-2 rounded shadow mt-4">
                    🧾 Cetak PDF
                </a>
