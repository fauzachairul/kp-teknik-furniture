<x-layout>
    ...
    <div class="flex justify-end">
        <button onclick="document.getElementById('categoriesModal').classList.remove('hidden')"
                    ...
                    <tr class="odd:bg-white even:bg-gray-50">
                        ...
                        <td class="px-4 py-2 text-sm text-blue-600">
                            <div class="flex gap-2 items-center">
                                <button class="edit-btn p-2 bg-yellow-500 text-white rounded cursor-pointer"
                                    data-id="{{ $category->id }}"
                                ...
                                <form class="delete-form"
                                    data-delete-url="{{ route('categories.hapus', $category->id) }}">
                                    <button type="button"
    ...
    <div id="categoriesModal"
        ...
        <div class="bg-white w-full max-w-lg p-6 rounded-lg shadow-lg relative">
            <!-- Close Button -->
            <button onclick="document.getElementById('categoriesModal').classList.add('hidden')"
            ...
            <form action="{{ route('categories.tambah') }}" method="POST" class="space-y-4">
                @csrf
                <div>
        ...
        <div class="flex justify-center items-center min-h-screen">
            ...
            <div id="modalContent"
                ...
                <form id="editCategoryForm">
                    ...
                    <!-- Modal Footer -->
                    <div class="flex justify-end">
                        <button type="button" id="closeModal2" class="mr-3 px-4 py-2 text-gray-600 hover:text-black">
                            Batal
                        </button>
                        <button type="submit" class="px-5 py-2 bg-black text-white rounded-md hover:bg-gray-900">
                            Simpan
                        </button>
                    </div>
                </form>
            ...
            $(function() {
                ...
                $('.edit-btn').on('click', function() {
                    ...
                    $.get(editUrl, function(data) {
                        ...
                        $('#editCategoryForm').data('update-url', updateUrl);
                        showModal();
                    });
                });
