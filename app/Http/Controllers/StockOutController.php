...
class StockOutController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.transaksis.stock-out', compact('project', 'bahan_baku', 'title'));
    }
    ...
    public function store(Request $request, Authenticatable $user)
    {
        ...
        // Simpan detail dan kurangi stock
        foreach ($rawMaterials as $index => $bahanId) {
            $jumlahKeluar = (int) ($jumlahs[$index] ?? 0);
        ...
        return redirect()->route('admin.transaksis.history-out')->with('success', 'Transaksi stock keluar berhasil disimpan.');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.transaksis.detail-out', compact('stockOut'));
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('admin.transaksis.history-out', compact('stockOuts'));
    }
    ...
    public function view_pdf($id)
    {
        ...
        $mpdf = new \Mpdf\Mpdf();
        $html = View::make('admin.transaksis.pdf.detail-out', $data)->render();
        $mpdf->WriteHTML($html);
        $mpdf->Output();
    }
    ...
    public function download_pdf($id)
    {
        ...
        $html = View::make('admin.transaksis.pdf.detail-out', $data)->render();
        $mpdf->WriteHTML($html);
        $mpdf->Output('detail-stock-keluar.pdf', 'D');
    }
}
