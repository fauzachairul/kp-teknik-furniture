...
class UserDashboardController extends Controller
{
    ...
    public function index(Authenticatable $user)
    {
        ...
        $txOutHariIni = $query->latest('tanggal_keluar')
            ->limit(10)
            ->get();
        return view('user.index', compact('totalTxOut', 'txOutHariIni'));
    }
    ...
    public function create()
    {
        ...
        return view('user.transaksis.stock-out', compact('project', 'bahan_baku', 'title'));
    }
    ...
    private function generateStockOutKode($jenis)
    {
        ...
        // Ambil record terakhir untuk hari ini dan jenis yang sama
